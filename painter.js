function draw() {
   ...
   startDrawWorker(imageData, width, height, redstring, greenstring, bluestring, tstate);
...
function startDrawWorker(imageData, width, height, redstring, greenstring, bluestring, tstate) {
   //Create Worker
